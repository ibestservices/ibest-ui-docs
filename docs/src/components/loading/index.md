...
| loadingColor          | `loading` 的颜色         | _ResourceColor_ | <div style="padding: 2px 4px; background: #c9c9c9; color: #fff; border-radius: 4px">#c9c9c9</div> |
| loadingTextColor      | `loading` 的文字颜色      | _ResourceColor_ | <div style="padding: 2px 4px; background: #969799; color: #fff; border-radius: 4px">#969799</div> |
