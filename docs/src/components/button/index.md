...
| btnPadding <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.6</span>| 按钮内边距                          | _Length_ \| _Padding_ \| _LocalizedPadding_ | `-` |
| stateEffect <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.6</span>| 是否开启按压态                                                | _boolean_ | `true` |
