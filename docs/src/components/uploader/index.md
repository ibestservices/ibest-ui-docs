...
| imageSelectOption <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.3</span>| 图片选择器配置 | _<a href="https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-photoaccesshelper#photoselectoptions">photoAccessHelper.PhotoSelectOptions</a>_ | `-` |
| fileSelectOption <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.3</span>| 文件选择器配置 | _<a href="https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentselectoptions">picker.DocumentSelectOptions</a>_ | `-` |
| beforeRemove <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.3</span>| 删除文件前的回调 | _(file: IBestUploaderFile, index: number) => Promise\<boolean\> \| boolean_ | `-` |
...
| uploadUrl <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.3</span>| 上传后地址      | _string_ | `''` |
...
| onExceed       | 超出限制后回调         | `-` |
| onRemove <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.3</span>| 删除文件后回调   | `file: IBestUploaderFile, allFile: IBestUploaderFile[]` |
| onFileClick <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.1.3</span>| 点击文件后回调, 仅当isPreviewFullImage为false时生效   | `file: IBestUploaderFile, index: number` |