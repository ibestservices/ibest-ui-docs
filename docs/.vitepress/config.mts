...
export default defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        name: "keywords",
        content: "ibest,IBest,Ibest,IBest-UI,ui,UI,鸿蒙,鸿蒙UI,鸿蒙UI库,鸿蒙UI框架,鸿蒙UI框架,鸿蒙UI组件,鸿蒙UI组件库,鸿蒙UI组件框架,百得思维,安徽百得思维,合肥百德思维,Harmony,OpenHarmony,HarmonyOS,HarmonyOS UI,HarmonyOS Ui,HarmonyOS Ui库,HarmonyOS Ui框架,HarmonyOS Ui组件,HarmonyOS Ui组件库,HarmonyOS Ui组件框架"
      }
    ]
  ],
  lastUpdated: true,
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: `Highlight 高亮文本 <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.0.7</span>`, link: "/components/highlight/" },
          ...
          { text: `Table 表格 <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.0.7</span>`, link: "/components/table/" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: `ImageCropper 图片裁剪 <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">2.0.6</span>`, link: "/components/imageCropper/" }
        ]
      }
    ],
    socialLinks: [
      { icon: "github", link: "https://github.com/ibestservices/ibest-ui" }
    ],
    docFooter: {
      prev: "上一页",
      next: "下一页"
